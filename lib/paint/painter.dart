...
class ConvexPainter extends CustomPainter {
  ...
  ConvexNotchedRectangle _shape = ConvexNotchedRectangle();
  // CircularOuterNotchedRectangle _shape = CircularOuterNotchedRectangle();
  ...
  ConvexPainter({
    ...
    _shape = ConvexNotchedRectangle(
      ...
      needNotched: needNotched,
    );
    // _shape = CircularOuterNotchedRectangle();
  }
